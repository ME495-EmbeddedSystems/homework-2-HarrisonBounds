...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['package.xml', 'urdf/turtle.urdf.xacro', 'launch/show_turtle.launch.py', 'config/view_robot.rviz', 'launch/run_turtle.launch.py', 'config/turtle.yaml', 'launch/show_turtle.launch.xml']),
    ],
